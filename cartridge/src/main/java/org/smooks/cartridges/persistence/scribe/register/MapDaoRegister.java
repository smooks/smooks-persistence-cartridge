 ...
 * <p>
 * A {@link org.smooks.scribe.register.MapDaoRegister} can be created via the static {@link #newInstance(Map)} method
...
public class MapDaoRegister<T> extends AbstractDaoRegister<T> {
    ...
    /**
     * Creates a new {@link org.smooks.scribe.register.MapDaoRegister} and fills it with the provided map.
     *
     * @param <T> the type of the DAO
     * @param map the map that fills the new {@link org.smooks.scribe.register.MapDaoRegister}
     * @return the new {@link org.smooks.scribe.register.MapDaoRegister}
     */
    ...
    /**
     * Creates a Builder object that can build a {@link org.smooks.scribe.register.MapDaoRegister}
     *
     * @param <T> The type of the DAO
     * @return The builder
     */
    ...
    public boolean equals(final Object obj) {
        ...
        @SuppressWarnings("unchecked") final MapDaoRegister<T> other = (MapDaoRegister<T>) obj;
    ...
    public static class Builder<T> {
         ...
         * DAO map
         *
         * @return the created {@link org.smooks.scribe.register.MapDaoRegister}
         */
