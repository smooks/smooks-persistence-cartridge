...
import org.smooks.scribe.invoker.AnnotatedDaoInvoker;
...
public class DaoInvokerFactory {
	...
	public static final String REPOSITORY_KEY = org.smooks.scribe.invoker.DaoInvokerFactory.class.getName() + "#REPOSITORY_KEY";
