...
import org.smooks.scribe.register.AbstractDaoRegister;
 ...
 * <p>
 * A {@link org.smooks.scribe.register.MultiDaoRegister} can be created via the static {@link #newInstance(Map)} method
...
public class MultiDaoRegister<T> extends AbstractDaoRegister<T> {
    ...
    /**
     * Creates a new {@link org.smooks.scribe.register.MultiDaoRegister} and fills it with the provided map.
     *
     * @param <T> the type of the DAO
     * @param map the map that fills the new {@link org.smooks.scribe.register.MultiDaoRegister}
     * @return the new {@link org.smooks.scribe.register.MultiDaoRegister}
     */
    ...
    /**
     * Creates a Builder object that can build a {@link org.smooks.scribe.register.MultiDaoRegister}
     *
     * @param <T> The type of the DAO
     * @return The builder
     */
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof org.smooks.scribe.register.MultiDaoRegister)) {
            return false;
        }

        @SuppressWarnings("unchecked") final MultiDaoRegister<T> other = (MultiDaoRegister<T>) obj;
    ...
    static class Builder<T> {
        ...
        /**
         * Creates the {@link org.smooks.scribe.register.MultiDaoRegister} and provides it with the
         * DAO register mapping
         *
         * @return the created {@link org.smooks.scribe.register.MultiDaoRegister}
         */
