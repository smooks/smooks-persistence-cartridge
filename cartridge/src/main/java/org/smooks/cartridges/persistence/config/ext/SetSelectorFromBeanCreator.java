...
public class SetSelectorFromBeanCreator implements DOMVisitBefore {
    ...
    public ResourceConfig findBeanCreatorConfig(String beanId, ExtensionContext extensionContext) {
        List<ResourceConfig> resourceConfigs = extensionContext.lookupResourceConfigs(new DefaultConfigSearch().resource(BeanInstanceCreator.class.getName()).param("beanId", beanId));
